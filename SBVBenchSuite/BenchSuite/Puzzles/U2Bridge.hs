...
benchmarks = bgroup "U2Bridge"
  [ mkOverheadBenchMark "U2Bridge_cnt1" (count 1)
  , mkOverheadBenchMark "U2Bridge_cnt2" (count 2)
  , mkOverheadBenchMark "U2Bridge_cnt3" (count 3)
  , mkOverheadBenchMark "U2Bridge_cnt4" (count 4)
  , mkOverheadBenchMark "U2Bridge_cnt6" (count 6)
  ]
  where
